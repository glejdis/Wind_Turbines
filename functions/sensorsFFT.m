function figFFT = sensorsFFT(loading)
...
load10He = healthyData{loading};
load10Bro = brokenToothData{loading};
...
sgtitle(strcat('Loading',int2str((loading-1)*10), '%'), 'FontSize', 18, 'fontweight', 'bold');
